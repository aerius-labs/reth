...
impl Database for DatabaseEnvIAVL {
    ...
    fn tx(&self) -> Result<Self::TX, DatabaseError> {
        println!("tx method in DATABASEENV");
        let caller_location = log_caller_location();
        println!("tx method called from {}", caller_location);
        Tx::new_with_metrics(
    ...
    fn tx_mut(&self) -> Result<Self::TXMut, DatabaseError> {
        println!("tx_mut method in DATABASEENV {:?}",&self);
        let caller_location = log_caller_location();
        println!("tx_mut method called from {}", caller_location);
        Tx::new_with_metrics(
...
mod tests {
    ...
    fn db_manual_put_get() {
        ...
        println!("the transaction is {tx:?} {env:?}");
